...
export default function ProductItem({
  ...
  const removeVariant = (variantId) => {
    if (product.variants.length === 1) {
      onRemove(); // remove entire product
    } else {
  ...
  return (
    ...
    >
      ...
      <div className="product-card">
        ...
        >
          {/* Product number */}
          <span {...dragHandleProps} style={{ fontWeight: "bold", width: "20px" }}>{index + 1}.</span>
        ...
        {onRemove && <button className="closeBtn" onClick={onRemove}></button>}
                ...
                >
                  {(provided) => (
                    ...
                    >
                      ...
                      {(canRemoveProduct || product.variants.length > 1) && (
                        <button
